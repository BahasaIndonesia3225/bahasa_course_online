...
import com.course.server.aop.RateLimiter;
...
public class CourseController {
    ...
    @GetMapping("/find/{id}")
    public ResponseDto  findCourse(@RequestHeader("token") String token, @PathVariable String id) {
        LOG.info("查找课程开始：{}", id);
        ResponseDto responseDto = new ResponseDto();
        CourseDto courseDto = courseService.findCourse(token, id);
